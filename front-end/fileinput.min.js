                    ...
                    this.input.addEventListener("change", function() {
                        ...
                        if (0 !== Q) {
                            ...
                            for (var B = 0; B < this.files.length; B++)
                                !function(B) {
                                    var I = A.files[B];
                                    g.cachedFileArray.push(I);
                                    var E = new FileReader;
                                    E.readAsDataURL(I),
                                        E.onload = function(A) {
                                            if (Q > 1)
                                                return g.inputLabel.innerHTML = Q + " files selected",
                                                    void (g.imagePreview.style.backgroundImage = 'url("' + g.successMultiple + '")');
                                            g.inputLabel.innerHTML = I.name,
                                                I.type.match("image/png") || I.type.match("image/jpeg") ? g.imagePreview.style.backgroundImage = 'url("' + E.result + '")' : I.type.match("application/pdf") ? g.imagePreview.style.backgroundImage = 'url("' + g.successPdf + '")' : I.type.match("video/*") ? g.imagePreview.style.backgroundImage = 'url("' + g.successVideo + '")' : g.imagePreview.style.backgroundImage = 'url("' + g.successFileAlt + '")'
                                        }
                                }(B)
                        }
                    }, !0),
